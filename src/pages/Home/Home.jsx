...
function Home() {
  return (
    <>
      ...
      {/* HERO / BANNER */}
      <section className="bg-white py-0 home-banner"> {/*ANTES era py-5 DA SECTION <section className="bg-light py-5 home-banner">*/}
        <Container>
          ...
          <Row className="g-4">
            <Col md={4}>
              <Card className="h-100 cartao-categoria">
                <Card.Img src="/produtosMaga.png" alt="Card image" className='cartao-imagem'/>
                <Card.Body>
